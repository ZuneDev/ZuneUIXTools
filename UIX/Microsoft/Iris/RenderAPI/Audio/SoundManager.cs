...
namespace Microsoft.Iris.RenderAPI.Audio
{
    public class SoundManager : IDisposable
    {
        ...
        public SoundManager(UISession uiSession, IRenderSession renderSession)
        {
        ...
        public string GetSystemSoundEventSource(SystemSoundEvent systemSoundEvent)
        {
        ...
        public ISoundBuffer GetSoundBuffer(string source)
        {
            bool flag = false;
