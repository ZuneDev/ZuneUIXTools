...
namespace Microsoft.Iris.Session
{
    ...
    public class Form : IModalSession
    {
        ...
        public IVisualContainer RootVisual => this.InternalWindow.VisualRoot;
        ...
        public void RefreshHitTarget() => this.InternalWindow.RefreshHitTarget();
        ...
        public void SetCapture(IRawInputSite captureSite, bool state) => this.InternalWindow.SetCapture(captureSite, state);
        ...
        public void ShadowEdgeResourceFromImage(
          UIImage uiimage,
          out string host,
        ...
        public virtual void OnShow(bool fShow, bool fFirstShow)
        {
        }
        ...
        public void NotifyWinEvent(int idEvent, int idObject, int idChild) => NotifyWinEvent(idEvent, this.__WindowHandle, idObject, idChild);

        [DllImport("user32.dll", CharSet = CharSet.Unicode)]
        private static extern void NotifyWinEvent(int idEvent, IntPtr hwnd, int idObject, int idChild);

        public void AttachChildZone(UIZone newZone)
        {
            this.m_zone = newZone;
