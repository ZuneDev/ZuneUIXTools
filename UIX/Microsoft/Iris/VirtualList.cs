...
namespace Microsoft.Iris
{
    public class VirtualList : ModelItem, IVirtualList, INotifyList, IList, ICollection, IEnumerable
    {
        ...
        public void FireSetChanged(UIListContentsChangeType type, int oldIndex, int newIndex) => this.FireSetChanged(type, oldIndex, newIndex, 1);
