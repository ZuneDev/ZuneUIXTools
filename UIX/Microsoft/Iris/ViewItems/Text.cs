...
{
    public class Text : ViewItem, ILayout
    {
      ...
      '\n'
        ...
        public TextStyle GetEffectiveTextStyle()
        {
        ...
        public static IImage GetImageForRun(UISession session, TextRun run, Color textColor)
        {
