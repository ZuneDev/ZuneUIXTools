...
{
    public class Repeater : ViewItem
    {
        public const int c_defaultItemFocusOrderValue = 2147483646;
      ...
      "RepeatedItemIndex"
        ...
        public bool GetFocusedIndex(ref int index)
        {
            bool flag = false;
        ...
        public void NavigateIntoIndex(int index) => this.NavigateIntoIndex(index, true);

        public void NavigateIntoIndex(int index, bool allowFaultIn)
        {
            ViewItem itemForVirtualIndex = this.GetRepeatedItemForVirtualIndex(index);
        ...
        public override void FaultInChild(ViewItemID child, ChildFaultedInDelegate handler) => this.FaultInChild(child.ID, PendingIndexRequestType.FaultInChild, handler);
        ...
        public ViewItem GetRepeatedItemForVirtualIndex(int index)
        {
            ViewItem viewItem = null;
        ...
        public class RepeatedViewItemSet
        {
        ...
        public struct RepeatedAndIndex
        {
