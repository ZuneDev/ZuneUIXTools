...
{
    public class AssemblyLoadResult : LoadResult
    {
        ...
        public static Type[] MapTypeList(TypeSchema[] typeSchemaList)
        {
        ...
        public static TypeSchema[] MapTypeList(Type[] typeList)
        {
        ...
        public static object WrapObject(TypeSchema typeSchema, object instance) => AssemblyObjectProxyHelper.WrapObject(typeSchema, instance);

        public static object WrapObject(object instance) => AssemblyObjectProxyHelper.WrapObject(null, instance);

        public static object UnwrapObject(object instance) => AssemblyObjectProxyHelper.UnwrapObject(instance);

        public static object[] UnwrapObjectList(object[] instanceList)
        {
