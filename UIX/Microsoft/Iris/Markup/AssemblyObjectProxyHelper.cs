...
{
    public static class AssemblyObjectProxyHelper
    {
        ...
        public static Type ProxyListType => typeof(AssemblyObjectProxyHelper.ProxyList);

        public static Type ProxyDictionaryType => typeof(AssemblyObjectProxyHelper.ProxyDictionary);

        public static Type ProxyCommandType => typeof(AssemblyObjectProxyHelper.ProxyCommand);

        public static Type ProxyValueRangeType => typeof(AssemblyObjectProxyHelper.ProxyValueRange);

        public static object WrapObject(TypeSchema typeSchema, object instance)
        {
            if (instance == null)
                return null;
        ...
        public static object UnwrapObject(object instance)
        {
            if (instance == null)
                return null;
