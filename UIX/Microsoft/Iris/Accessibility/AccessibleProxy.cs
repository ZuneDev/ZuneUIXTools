...
namespace Microsoft.Iris.Accessibility
{
    ...
    public class AccessibleProxy : Microsoft.Iris.OS.CLR.StandardOleMarshalObject, IAccessible, IEnumVARIANT
    {
        ...
        public AccessibleProxy(UIClass ui, Accessible data)
        {
            this._ui = ui;
            this._data = data;
        ...
        public static bool AccessibilityActive
        {
            get => s_accessibilityActive;
            set => s_accessibilityActive = true;
        }

        public virtual IAccessible Parent => this._ui.Parent != null ? _ui.Parent.AccessibleProxy : null;

        public int ChildCount => this._ui.Children.Count;
        ...
        public string Description => this._data.Description;

        public AccRole Role => this._data.Role;

        public AccStates State
        {
            get
            {
        ...
        public string Help => this._data.Help;

        public int HelpTopic => this._data.HelpTopic;

        public string KeyboardShortcut => this._data.KeyboardShortcut;

        public bool HasFocus => this._ui.DirectKeyFocus;

        public string DefaultAction => this._data.DefaultAction;
        ...
        public virtual IAccessible Navigate(AccNavDirs navDir)
        {
        ...
        public static void NotifyCreated(UIClass ui)
        {
        ...
        public static void NotifyDestroyed(UIClass ui)
        {
            if (!AccessibilityActive)
                return;
        ...
        public static void NotifyTreeChanged(UIClass ui)
        {
        ...
        public static void NotifyVisibilityChange(UIClass ui, bool visible)
        {
            if (!AccessibilityActive || !ui.Initialized)
                return;
        ...
        public static void NotifyFocus(UIClass ui)
        {
            if (!AccessibilityActive || !ui.Initialized)
                return;
        ...
        public void NotifyAccessiblePropertyChanged(AccessibleProperty property)
        {
        ...
        public static AccessibleProxy AccessibleProxyFromID(int proxyID)
        {
