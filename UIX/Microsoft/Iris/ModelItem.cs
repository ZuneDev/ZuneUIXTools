...
namespace Microsoft.Iris
{
      ...
      IThreadSafeObject
    {
        ...
        public object GetData(DataCookie cookie) => this._dataMap.GetData(cookie);

        public void SetData(DataCookie cookie, object value) => this._dataMap.SetData(cookie, value);

        public Delegate GetEventHandler(EventCookie cookie) => this._dataMap.GetEventHandler(cookie);

        public void AddEventHandler(EventCookie cookie, Delegate handlerToAdd) => this._dataMap.AddEventHandler(cookie, handlerToAdd);

        public void RemoveEventHandler(EventCookie cookie, Delegate handlerToRemove) => this._dataMap.RemoveEventHandler(cookie, handlerToRemove);

        public void RemoveEventHandlers(EventCookie cookie) => this._dataMap.RemoveEventHandlers(cookie);
