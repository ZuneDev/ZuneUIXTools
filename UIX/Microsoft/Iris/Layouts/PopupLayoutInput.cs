...
{
    public class PopupLayoutInput : NotifyObjectBase, ILayoutInput
    {
        ...
        public static DataCookie Data => PopupLayout.DataCookie;
        ...
        public bool TargetIsMouse => this._placementMode != null && this._placementMode.MouseTarget == MouseTarget.Fixed;

        public bool TargetIsFollowMouse => this._placementMode != null && this._placementMode.MouseTarget == MouseTarget.Follow;

        public static PopupLayoutInput Default
        {
            get
            {
                if (s_default == null)
