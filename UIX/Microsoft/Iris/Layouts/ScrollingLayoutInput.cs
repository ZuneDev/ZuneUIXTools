...
{
    public class ScrollingLayoutInput : ILayoutInput
    {
        ...
        public int ScrollAmount => this._scrollAmount;

        public void SetScrollAmount(int scrollAmount) => this._pendingScrollAmount = scrollAmount;
