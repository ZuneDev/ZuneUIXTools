...
{
    public abstract class InputHandler : DisposableNotifyObjectBase
    {
        ...
        public void NotifyLoseDeepKeyFocus() => this.OnLoseDeepKeyFocus();

        public void NotifyGainDeepKeyFocus() => this.OnGainDeepKeyFocus();

        public virtual CursorID GetCursor() => CursorID.NotSpecified;
