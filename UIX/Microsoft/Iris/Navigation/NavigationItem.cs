...
namespace Microsoft.Iris.Navigation
{
    public abstract class NavigationItem
    {
        ...
        [Conditional("DEBUG")]
        public void DebugTraceFocusRank()
        {
        ...
        public NavigationItem SearchUpTree(
          RectangleF startRectangleF,
        ...
        public NavigationItem SearchDownTree(
          RectangleF startRectangleF,
          bool depthFirst,
          INavigationSite excludeStickyContainerSite,
        ...
        public static void RememberFocus(INavigationSite focusSite)
        {
        ...
        public static NavigationItem CreateAreaForSite(
        ...
        public static NavigationOrientation GetFlowOrientation(
          INavigationSite targetSite,
          Direction searchDirection)
        {
            NavigationPolicies mode = targetSite.Mode;
        ...
        public static bool IsBoundingSite(INavigationSite targetSite, Direction searchDirection)
        {
            NavigationPolicies mode = targetSite.Mode;
            switch (searchDirection)
            {
        ...
        public static bool IsWrappingSite(INavigationSite targetSite, Direction searchDirection)
        {
            NavigationPolicies mode = targetSite.Mode;
            switch (searchDirection)
            {
        ...
        public static bool IsPreferFocusOrderContainer(INavigationSite targetSite) => (targetSite.Mode & NavigationPolicies.PreferFocusOrder) == NavigationPolicies.PreferFocusOrder;

        public static bool IsPreferContainerFocus(INavigationSite targetSite) => (targetSite.Mode & NavigationPolicies.PreferContainerFocus) == NavigationPolicies.PreferContainerFocus;

        public static bool IsTabGroup(INavigationSite targetSite) => (targetSite.Mode & NavigationPolicies.TabGroup) == NavigationPolicies.TabGroup;
