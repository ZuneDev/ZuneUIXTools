...
namespace Microsoft.Iris.Drawing
{
    public struct Color
    {
        ...
        public void GetArgb(out float a, out float r, out float g, out float b)
        {
        ...
        public static Color FromArgb(float alpha, float red, float green, float blue) => FromArgb(ChannelFromFloat(alpha), ChannelFromFloat(red), ChannelFromFloat(green), ChannelFromFloat(blue));
        ...
        public static Color FromHSV(int nAlpha, float flHue, float flSaturation, float flValue)
        {
            if (flSaturation == 0.0)
        ...
        public ColorF RenderConvert() => new ColorF(A, R, G, B);
