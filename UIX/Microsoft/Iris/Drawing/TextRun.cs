...
{
    public sealed class TextRun : SharedDisposableObject
    {
        ...
        public void ApplyOffset(Point offsetPoint)
        {
        ...
        public Dib Rasterize(string samplingMode, Color textColor, bool outlineFlag)
        {
        ...
        public static unsafe TextRun FromRunPacket(
          IntPtr hGlyphRunInfo,
          NativeApi.RasterizeRunPacket* runPacketPtr,
          string content)
        {
