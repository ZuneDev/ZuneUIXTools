...
{
    public sealed class TextFlow : DisposableObject
    {
        ...
        public Rectangle GetLastLineBounds(int lineAlignmentOffset)
        {
        ...
        public bool IsOnLastLine(TextRun run) => run.Line == this.LastFitRun.Line;
