...
namespace Microsoft.Iris.Drawing
{
    public abstract class UIImage : NotifyObjectBase
    {
        ...
        public IImage RenderImage => this.GetCacheItem()?.RenderImage;
        ...
        public void AddUser(object user) => this.GetCacheItem()?.RegisterUsage(user);

        public void RemoveUser(object user) => this.GetCacheItem()?.UnregisterUsage(user);

        public static Size MaximumSurfaceSize(UISession session)
        {
        ...
        public static Size ClampSize(Size maxSizeImage)
        {
