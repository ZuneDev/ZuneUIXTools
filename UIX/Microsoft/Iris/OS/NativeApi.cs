...
namespace Microsoft.Iris.OS
{
    ...
    public static unsafe class NativeApi
    {
        ...
        public const uint WM_IME_STARTCOMPOSITION = 269;
        public const uint WM_IME_ENDCOMPOSITION = 270;
        public const uint FM_DEFERRED_IME_DISASSOCIATE_CONTEXT = 1032;
        ...
        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextBuildObject(
          bool fRichTextMode,
        ...
        [DllImport("UIXRender.dll")]
        public static extern void SpRichTextDestroyObject(Win32Api.HANDLE hRto);

        [DllImport("UIXRender.dll")]
        public static extern void SpRichTextDestroyGlyphRunInfo(IntPtr hGlyphRunInfo);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextForwardKeyCharacter(
        ...
        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextForwardKeyState(
          Win32Api.HANDLE hRto,
          uint message,
          int virtualKey,
          int scanCode,
        ...
        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextForwardMouseInput(
          Win32Api.HANDLE hRto,
          uint message,
          uint modifierState,
          int mouseButton,
        ...
        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextForwardImeMessage(
          Win32Api.HANDLE hRto,
          uint message,
          UIntPtr wParam,
          UIntPtr lParam);
        ...
        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextGetNaturalBounds(
          Win32Api.HANDLE hRto,
          out int cWidth,
          out int cHeight);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextGetSimpleContent(
          Win32Api.HANDLE hRto,
          StringBuilder textBuffer,
          int cchBuffer);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextGetSimpleContentLength(
          Win32Api.HANDLE hRto,
          out int textLength);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextMeasure(
          Win32Api.HANDLE hRto,
        ...
        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextRasterize(
        ...
        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetFocus(
          Win32Api.HANDLE hRto,
          bool gainingFocus);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetContent(
          Win32Api.HANDLE hRto,
          string pszContent);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetWordWrap(
          Win32Api.HANDLE hRto,
          bool fWordWrap);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetMaximumLength(
          Win32Api.HANDLE hRto,
          int maximumLength);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetDetectUrls(
          Win32Api.HANDLE hRto,
          bool detectUrls);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetOversampleMode(
          Win32Api.HANDLE hRto,
          bool fOversample);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextCut(Win32Api.HANDLE hRto);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextCopy(Win32Api.HANDLE hRto);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextPaste(Win32Api.HANDLE hRto);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextDelete(Win32Api.HANDLE hRto);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextCanUndo(Win32Api.HANDLE hRto, out bool canUndo);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextUndo(Win32Api.HANDLE hRto);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetReadOnly(Win32Api.HANDLE hRto, bool readOnly);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextSetScale(Win32Api.HANDLE hRto, float flScale);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextSetSelectionRange(
          Win32Api.HANDLE hRto,
          int selectionStart,
          int selectionEnd);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern HRESULT SpRichTextOnTimerTick(Win32Api.HANDLE hRto, uint timerId);

        [DllImport("UIXRender.dll")]
        public static extern bool SpSimpleTextIsAvailable();

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpSimpleTextBuildObject(
          Size sizeMaximumSurface,
          out Win32Api.HANDLE hSto);

        [DllImport("UIXRender.dll")]
        public static extern void SpSimpleTextDestroyObject(Win32Api.HANDLE hSto);

        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern unsafe HRESULT SpSimpleTextMeasure(
        ...
        [DllImport("UIXRender.dll", CharSet = CharSet.Unicode)]
        public static extern unsafe HRESULT SpSimpleTextMeasurePossible(
          Win32Api.HANDLE hSto,
          string pszRef,
          TextStyle.MarshalledData* textStyle,
          out bool fPossible);
        ...
        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextScroll(
          Win32Api.HANDLE hRto,
          int whichBar,
          int scrollType);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextScrollToPosition(
          Win32Api.HANDLE hRto,
          int whichBar,
          int whereTo);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRichTextSetScrollbars(
          Win32Api.HANDLE hRto,
          bool allowVertical,
          bool allowHorizontal);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpRegisterImeCallbacks(
          [MarshalAs(UnmanagedType.Interface)] IImeCallbacks pImeCallbacks,
          out uint dwToken);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpUnregisterImeCallbacks(uint dwToken);

        [DllImport("UIXRender.dll")]
        public static extern HRESULT SpPostDeferredImeMessage(
          uint message,
          UIntPtr wParam,
          UIntPtr lParam);
        ...
        public unsafe delegate HRESULT ReportRunCallback(
          IntPtr hGlyphRunInfo,
          NativeApi.RasterizeRunPacket* pRun,
          IntPtr lpString,
          uint nChars,
        ...
        public enum ScrollNotification
        {
            LineUp,
            LineDown,
            PageUp,
