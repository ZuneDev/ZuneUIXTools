...
{
    public struct NativeXmlReader : IDisposable
    {
        //private IntPtr _nativeReader;
        ...
        public NativeXmlReader(Resource resource)
          : this(false)
          => this.Init(resource.Uri, (int)resource.Length, false);

        public NativeXmlReader(string source, bool isFragment)
          : this(false)
        {
            this.Init(source, source.Length * 2, isFragment);
        }
        ...
        private NativeXmlReader(bool placeHolder)
        {
            ...
            this._curNodeType = XmlNodeType.None;
            this._prevNodeType = XmlNodeType.None;
        }

        private void Init(string source, int length, bool isFragment)
        {
            _reader = XmlReader.Create(source);
        }
        ...
        public bool Read(out XmlNodeType nodeType)
        {
            ...
            this._curNodeType = _reader.NodeType;
            return flag;
        }
        ...
        public bool IsInlineExpression
        {
            get
            {
        ...
        public SSLexUnicodeBufferConsumer LexConsumerForValueWithPrefix(string prefix)
        {
            ...
            if (this._curNodeType == XmlNodeType.CDATA && this._prevNodeType != XmlNodeType.Whitespace)
                column += 9;
        ...
        private void ThrowXmlException(uint hr)
        {
            ...
            switch (hr)
            {
                ...
                case 3222072898:
                    ...
                    break;
                case 3222072899:
                    message = "Well-formedness constraint: pes in public subset";
                    break;
                case 3222072900:
            ...
            if (message != null)
            {
                int lineNumber = this._reader == null ? -1 : this.InternalLineNumber;
                int linePosition = this._reader == null ? -1 : this.InternalLinePosition;
