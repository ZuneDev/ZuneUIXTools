...
namespace Microsoft.Iris
{
    public class Group : VirtualList
    {
        ...
        public Group(GroupedList groupedList, int startIndex, int count)
        ...
        public override void OnCountChanged() => this.FirePropertyChanged("EndIndex");

        private int GetSourceIndex(int groupedIndex) => this.StartIndex + groupedIndex;

        public bool ContainsSourceIndex(int sourceIndex) => this.StartIndex <= sourceIndex && sourceIndex <= this.EndIndex;
