...
namespace Microsoft.Iris.Input
{
    public class InputManager : IRawInputCallbacks
    {
        ...
        public InputManager(UISession session)
        {
        ...
        public void ConnectToRenderer() => this.Session.RenderSession.InputSystem.RegisterRawInputCallbacks(this);
        ...
        public InputQueue Queue => this._inputQueue;

        public InputModifiers Modifiers => this.Keyboard.KeyboardModifiers | this.Mouse.MouseModifiers;

        public InputModifiers DragModifiers => this._inputQueue.DragModifiers;
        ...
        public void UpdateLastInputTime() => this._lastInputTime = DateTime.UtcNow;
        ...
        public void RevalidateInputSiteUsage(
        ...
        public bool FilterKeyboardEvent(KeyStateInfo info)
        {
            switch (info.Action)
            {
                case KeyAction.Up:
        ...
        public ICookedInputSite HitTestInput(
        ...
        public bool IsValidCookedInputSite(ICookedInputSite target) => target == null || (target as ITreeNode).Zone != null;

        public bool IsSiteInfluencedByPeer(ICookedInputSite target, ICookedInputSite peer)
        {
        ...
        public bool IsValidKeyFocusSite(ICookedInputSite target)
        {
        ...
        public void RepairInvalidKeyFocus(uint attemptCount)
        {
        ...
        public void RequestHostKeyFocus(ICookedInputSite target)
        {
        ...
        public void RequestHostMouseCapture(IRawInputSite rawSource, bool state)
        {
        ...
        public void DeliverInput(ICookedInputSite target, InputInfo info)
        {
        ...
        public InputModifiers HACK_SystemModifiers => this._HACK_sysModifiers;

        public void HACK_UpdateSystemModifiers(InputModifiers modifiers) => this._HACK_sysModifiers = modifiers;
