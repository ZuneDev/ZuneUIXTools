...
{
    public class DragHandler : InputHandler
    {
        ...
        public override CursorID GetCursor() => this._dragCursor != CursorID.NotSpecified && this.Dragging ? this._dragCursor : CursorID.NotSpecified;
