...
{
    private static readonly Uri BaseUri = new("avares://IrisInspector/Styles");
    ...
    private static readonly Styles FluentDark = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://IrisInspector/Themes/FluentDark.axaml")
        }
    };
    ...
    private static readonly Styles FluentLight = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://IrisInspector/Themes/FluentLight.axaml")
        }
    };
